      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            // 2. Dashboard summary + 4. Recent applications, both driven by live data
            StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
              ...
              builder: (context, oppSnapshot) {
                ...
                final activeCount = opportunities
                    ...
                    .length;
                // Assumes opportunities with type == 'Event' represent events;
                // adjust if you track events in a separate collection instead.
