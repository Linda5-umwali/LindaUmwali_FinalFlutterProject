...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  final List<_OnboardingPageData> _pages = [
    _OnboardingPageData(
      ...
      subtitle:
          'Discover opportunities within the ALU community and connect with like-minded individuals.',
    ),
    _OnboardingPageData(
      icon: Icons.work_outline_rounded,
      title: 'Discover Opportunities',
      subtitle:
          'Find internships, campus events, and career opportunities all in one place.',
    ),
    _OnboardingPageData(
