                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                            ...
                            children: [
                              ...
                              if (_isLogin)
                                Align(
                                  ...
                                  child: TextButton(
                                    onPressed: () {
                                      // TODO: wire up FirebaseAuth.instance.sendPasswordResetEmail(email: ...)
                              ...
                              // Role picker - only shown during sign-up, since a
                              // logging-in user's role is already set on their profile.
                              if (!_isLogin) ...[
                        ...
                        // Google/Email social buttons removed for now - they were
                        // non-functional placeholders (onPressed: () {}). Add back
                        // once google_sign_in is wired up, or leave email/password
                        // as the only method for the demo.
      ...
      children: [
        Container(
          ...
          child: ClipRRect(
            ...
            // Fixed: was 'lib/images/Alu_logo.png' - lib/ is Dart source only.
            child: Image.asset(
