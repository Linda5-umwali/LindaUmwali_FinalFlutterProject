...
class _HomeScreenState extends State<HomeScreen> {
  // Filters by the `category` field. If you intended chips to filter by
  // `type` (Internship/Part-time/etc.) instead, swap `opp.category` for
  // `opp.type` in _filteredList() and update this list to match.
